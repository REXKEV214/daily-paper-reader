...
**Motivation**：尽管上下文信息能显著提升模型性能，但其在Transformer中的理论作用机制及误差减少的根本原因仍缺乏统一解释。 \
**Method**：提出了一个基于输出误差动力学的理论框架，将上下文影响分解为基准误差与受相关性和互补性约束的修正向量。 \
**Result**：理论推导给出了误差减少的几何必要条件，并在ICL、RAG等实验中验证了该理论对性能提升的指导作用。 \
**Conclusion**：该研究为理解上下文如何修正LLM输出提供了严谨的数学基础，并为优化上下文选择提供了原则性的策略支持。
