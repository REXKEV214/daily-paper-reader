...
date: 2026-03-07
pdf: "https://arxiv.org/pdf/2603.07036v1"
tags: ["query:social-computing"]
score: 7.0
evidence: 数字平台上的集体知识和社区实践
tldr: 本研究探讨了YouTube创作者如何利用生成式人工智能（GenAI）进行变现。通过分析377个相关视频，研究揭示了创作者共享的十种变现用例及策略，如广告和联盟营销。研究还揭示了虚假收入声明、内容盗用等结构性矛盾，为设计以创作者为中心的AI技术和平台政策提供了参考。
selection_source: fresh_fetch
motivation: 旨在了解YouTube创作者社区如何集体构建关于利用生成式AI进行内容变现的知识与实践。
method: 对377个公开推广GenAI工作流、收入声明和变现策略的YouTube视频进行了定性分析。
result: 识别出十种AI支持的收入机会，并揭示了收入真实性、内容侵权及合成参与等结构性紧张关系。
conclusion: 研究概念化了创作者对GenAI的集体认知，并对未来AI技术设计和负责任的平台政策制定提出了建议。
---
